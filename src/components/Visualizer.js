...
const Visualizer = () => {
  ...
  const dijkstra = (grid, startNode, endNode) => {
    ...
    const unvisitedNodes = getAllNodes(grid);  // fro 2-d array spread operator wont works 

    while (unvisitedNodes.length) {
      sortNodesByDistance(unvisitedNodes);
      const closestNode = unvisitedNodes.shift(); // remomve the first elemt of unvisitedNodes array originally also
